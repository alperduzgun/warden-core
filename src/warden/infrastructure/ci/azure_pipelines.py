...
class AzurePipelinesTemplate:
    ...
    def generate(config: AzurePipelinesConfig) -> str:
        ...
        trigger_section = AzurePipelinesTemplate._generate_triggers(config.trigger_branches)

        publish_section = AzurePipelinesTemplate._generate_publish() if config.publish_artifacts else ""
