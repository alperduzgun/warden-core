...
class PipelinePhaseRunner:
    ...
    async def execute_all_phases(
        ...
        if enable_validation:
            ...
            if self._progress_callback:
                self._progress_callback("progress_init", {
    ...
    def _apply_manual_frame_override(
        self, context: PipelineContext, frames_to_execute: list[str]
    ) -> None:
    ...
    def _finalize_pipeline_status(
        self, context: PipelineContext, pipeline: ValidationPipeline
    ) -> None:
    ...
    def _calculate_total_work_units(
    ...
    async def _execute_lsp_diagnostics_async(
        ...
        if self._progress_callback:
            self._progress_callback("phase_started", {
        ...
        try:
            ...
            if self._progress_callback:
                self._progress_callback("phase_completed", {
                    "phase": "LSP_DIAGNOSTICS",
                    "phase_name": "LSP Diagnostics",
                })
