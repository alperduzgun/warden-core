...
from warden.analyzers.cleanup.models import CleanupResult, CleanupIssueSeverity
from warden.validation.domain.frame import CodeFile


class CleanupAnalyzerPriority:
    """
...
class BaseCleanupAnalyzer(ABC):
    ...
    async def analyze_async(
        ...
        Returns:
            CleanupResult with detected issues and suggestions
