...
from warden.analyzers.cleanup.base import BaseCleanupAnalyzer
from warden.analyzers.cleanup.models import CleanupResult, CleanupSuggestion
...
class CleanupAnalyzer:
    ...
    def __init__(self, analyzers: Optional[List[BaseCleanupAnalyzer]] = None):
        """
    ...
    def get_analyzers(self) -> List[BaseCleanupAnalyzer]:
        """Get list of registered analyzers."""
        return self._analyzers.copy()

    def add_analyzer(self, analyzer: BaseCleanupAnalyzer) -> None:
        """
        Add a new analyzer.
