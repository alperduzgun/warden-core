...
class TestabilityAnalyzer(BaseCleanupAnalyzer):
    """
    ...
    async def analyze_async(
        ...
        Returns:
            CleanupResult with testability metrics
        """
    ...
    def _analyze_function_testability(self, node: ast.FunctionDef, tree: ast.AST) -> List[CleanupIssue]:
        ...
        if has_side_effects:
            issues.append(
                CleanupIssue(
                    issue_type=CleanupIssueType.TESTABILITY_ISSUE,
    ...
    def _analyze_class_testability(self, node: ast.ClassDef) -> List[CleanupIssue]:
    ...
    def _detect_global_state_usage(self, tree: ast.AST) -> List[CleanupIssue]:
    ...
    def _check_static_methods(self, node: ast.ClassDef) -> List[CleanupIssue]:
